package jdromedaplugin.properties;

import static jdromedaplugin.preferences.Preferences.DEFAULT_PROFILE_NAME;
...
public class JdromedaProjectPage  extends FieldEditorProjectPreferencePage implements IWorkbenchPreferencePage {
			...
			if (result == 1) { // cancel
				...
				if (result == 2) {
					if (this.isPropertyPage()) {
						...
						JdromedaBuilder.cleanProject(project);
					} else {
						JdromedaBuilder.cleanWorkspace();
					}
				}
			}
	...
	protected IPreferenceStore doGetPreferenceStore() {
		return JdromedaPlugin.getDefault().getPreferenceStore();
	}

	@Override
	protected String getPreferenceNodeId() {
		return "jdromedaplugin.properties.JdromedaProjectsPage";
	}
